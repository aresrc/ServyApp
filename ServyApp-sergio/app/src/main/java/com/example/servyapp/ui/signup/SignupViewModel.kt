...
class SignupViewModel @Inject constructor(
    ...
    fun registerButtonPressed(){
        when {
            ...
            !_uiState.value.email.contains("@") || !_uiState.value.email.contains(".") -> {
                _uiState.update { it.copy(mostrarMensajeError = true) }
        ...
        viewModelScope.launch {
            ...
            val result = signupUseCase.execute(_uiState.value.email, _uiState.value.password, _uiState.value.phone)
